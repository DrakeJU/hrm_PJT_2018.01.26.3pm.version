...
<body>
	<div style='background: url("http://login.ecounterp.com/MemberInfo/Logo/_G0080_3cd2e3fe35d14ce4d9e17e4dc1f39e70_sign.gif") 
		...
		<div>
			...
			<div style="border: 1px solid rgb(0, 0, 0); border-image: none;">
				...
				<table style="margin: 13px 0px 0px; width: 650px; color: rgb(0, 0, 0); font-size: 12px; 
								border-top-color: rgb(0, 0, 0); border-top-width: 1px; border-top-style: solid; 
								border-collapse: collapse; table-layout: fixed;" border="0" cellspacing="0" cellpadding="0">
					<colgroup>
					...
					<tbody>
						...
						<tr>
							<th	style="height: 40px; text-align: center; font-weight: bold; border-right-color: rgb(0, 0, 0); 
										border-bottom-color: rgb(0, 0, 0); border-right-width: 1px; border-bottom-width: 1px; 
										border-right-style: solid; border-bottom-style: solid;">생년월일
							</th>
							<td	style="text-align: left; border-bottom-color: rgb(0, 0, 0); border-bottom-width: 1px; 
										border-bottom-style: solid;">&nbsp;<input type="text" value="" style="border:none">
							</td>
						...
						<tr>
							<th	style="height: 40px; text-align: center; font-weight: bold; border-right-color: rgb(0, 0, 0); 
										border-bottom-color: rgb(0, 0, 0); border-right-width: 1px; border-bottom-width: 1px; 
										border-right-style: solid; border-bottom-style: solid;">주 소
							</th>
							<td style="height: 40px; text-align: left; border-bottom-color: rgb(0, 0, 0); 
						...
						<tr>
							<th style="height: 40px; text-align: center; font-weight: bold; border-right-color: rgb(0, 0, 0); 
										border-bottom-color: rgb(0, 0, 0); border-right-width: 1px; border-bottom-width: 1px; 
										border-right-style: solid; border-bottom-style: solid;">근무기간
							</th>
							<td style="height: 40px; text-align: left; border-bottom-color: rgb(0, 0, 0); border-bottom-width: 1px; 
										border-bottom-style: solid;">
										&nbsp;<input type="text" value="" style="border:none">
						...
						<tr>
							<th	style="height: 40px; text-align: center; font-weight: bold; border-right-color: rgb(0, 0, 0); 
										border-bottom-color: rgb(0, 0, 0); border-right-width: 1px; border-bottom-width: 1px; 
										border-right-style: solid; border-bottom-style: solid;">용 도
							</th>
							<td style="height: 40px; text-align: left; border-bottom-color: rgb(0, 0, 0); border-bottom-width: 1px; 
										border-bottom-style: solid;">
										&nbsp;<input type="text" value="" style="border:none">
				...
				<table style="width: 650px;" border="0" cellspacing="0"	cellpadding="0">
					<tbody>
						<tr>
							<td style="height: 300px; text-align: center; padding-top: 30px; font-size: 16px; font-weight: bold; 
										vertical-align: top;">위와 같이 증명합니다.
							</td>
						</tr>
						<tr>
