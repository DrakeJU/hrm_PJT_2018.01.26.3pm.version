...
import com.example.spring.salmanager.service.PayimfService;

@Controller
public class PayimfController {
	private static final Logger logger = LoggerFactory.getLogger(PayimfController.class);
